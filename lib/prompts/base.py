...
def registry_versions() -> Dict[str, Dict[str, PromptSpec]]:
    ...
    from lib.prompts import (
        distill, document, dpo, identity, judge, magpie, multimodal, style, translation, tuning,
    )

    all_specs: Dict[str, Dict[str, PromptSpec]] = {}
    for mod in (magpie, distill, judge, translation, identity, document, tuning, style, multimodal, dpo):
        for name in dir(mod):
